...
var $author$project$CheckList$LocalStorage = F3(
	function (currentTime, flightInfo, checkListItems) {
		return {g: checkListItems, _: currentTime, a: flightInfo};
	});
...
var $author$project$CheckList$FlightInfo = F8(
	function (flightNumber, departureAirport, arrivalAirport, departureTime, arrivalTime, depatureTotalMinutes, departureIsNextUTCDay, gate) {
		return {F: arrivalAirport, G: arrivalTime, H: departureAirport, t: departureIsNextUTCDay, y: departureTime, z: depatureTotalMinutes, I: flightNumber, J: gate};
	});
...
var $author$project$CheckList$decodeLocalStrorage = A4(
	...
	A2($elm$json$Json$Decode$field, 'checkListItems', $author$project$CheckList$decodeDict));
	...
	return _Utils_Tuple2(
		function () {
			...
			if (!_v0.$) {
				...
				var flightInfo = localStorage.a;
				var newfi = _Utils_update(
					flightInfo,
					{
						z: $author$project$CheckList$getTotalMinutes(
							$author$project$CheckList$getValidTime(flightInfo.y))
					});
				return {
					g: localStorage.g,
					a: newfi,
					B: false,
					M: $elm$time$Time$millisToPosix(localStorage._)
				};
			} else {
				return {
					g: $author$project$CheckList$initCheckList,
					a: {
						F: 'KMEM',
						G: $author$project$CheckList$getTimeString(
							_Utils_Tuple2(0, 0)),
						H: 'KMEM',
						t: false,
						y: $author$project$CheckList$getTimeString(
							_Utils_Tuple2(0, 0)),
						z: 0,
						I: '0000',
						J: 'UNKN'
...
var $elm$time$Time$State = F2(
	function (taggers, processes) {
		return {ao: processes, ay: taggers};
	});
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'flightNumber',
				$elm$json$Json$Encode$string(fi.I)),
				_Utils_Tuple2(
				'departureAirport',
				$elm$json$Json$Encode$string(fi.H)),
				_Utils_Tuple2(
				'arrivalAirport',
				$elm$json$Json$Encode$string(fi.F)),
				_Utils_Tuple2(
				'departureTime',
				$elm$json$Json$Encode$string(fi.y)),
				_Utils_Tuple2(
				'arrivalTime',
				$elm$json$Json$Encode$string(fi.G)),
				_Utils_Tuple2(
				'depatureTotalMinutes',
				$elm$json$Json$Encode$int(fi.z)),
				_Utils_Tuple2(
				'departureIsNextUTCDay',
				$elm$json$Json$Encode$bool(fi.t)),
				_Utils_Tuple2(
				'gate',
				$elm$json$Json$Encode$string(fi.J))
			]));
};
var $author$project$CheckList$encodeDict = function (dict) {
	return $elm$json$Json$Encode$object(
		A2(
			$elm$core$List$map,
			function (_v0) {
...
var $author$project$CheckList$saveDict = _Platform_outgoingPort('saveDict', $elm$core$Basics$identity);
		...
		switch (msg.$) {
			...
			case 3:
				...
				var newfi = _Utils_update(
					...
					{
						H: $elm$core$String$toUpper(departureAirport)
					});
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			case 4:
				...
				var newfi = _Utils_update(
					...
					{
						F: $elm$core$String$toUpper(arrivalAirport)
					});
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						...
						$author$project$CheckList$encode(newModel.a)),
						$author$project$CheckList$saveDict(
						$author$project$CheckList$encodeDict(newModel.g)),
						cmds
					])));
	});
...
var $author$project$CheckList$getTimeToDeparture = F3(
	function (currentTime, departureTime, isNextDay) {
		var m = A2($elm$time$Time$toMinute, $elm$time$Time$utc, currentTime);
		var h = A2($elm$time$Time$toHour, $elm$time$Time$utc, currentTime);
		var currentTotalMinutes = $author$project$CheckList$getTotalMinutes(
			_Utils_Tuple2(h, m));
		return isNextDay ? (currentTotalMinutes - (1440 + departureTime)) : (currentTotalMinutes - departureTime);
	});
...
var $author$project$CheckList$toFixed = F2(
	function (decimalPlaces, _float) {
		return A2($myrho$elm_round$Round$round, decimalPlaces, _float);
	});
var $author$project$CheckList$viewClockCard = function (model) {
	var timeToDeparture = A3($author$project$CheckList$getTimeToDeparture, model.M, model.a.z, model.a.t);
	var timeToDepartureHours = A2($author$project$CheckList$toFixed, 2, timeToDeparture / 60);
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(timeToDepartureHours + ' Hours')
					]))
			]));
};
var $author$project$CheckList$ShowEditor = {$: 0};
...
var $author$project$CheckList$viewHeaderCard = F2(
	function (title, gate) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('title'),
							$elm$html$Html$Events$onClick($author$project$CheckList$ShowEditor)
						]),
					_List_fromArray(
						[
...
var $author$project$CheckList$viewLinkCard = F3(
	function (title, time, isNextDay) {
		...
		var linkUrl = 'https://aviationweather.gov/impactboard/?id=' + (title + '&rwywind=both');
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A2($author$project$CheckList$viewHeaderCard, 'FDX' + model.a.I, model.a.J),
						A3($author$project$CheckList$viewLinkCard, model.a.H, model.a.y, model.a.t),
						A3($author$project$CheckList$viewLinkCard, model.a.F, model.a.G, model.a.t),
						$author$project$CheckList$viewClockCard(model)
					]))
			]));
};
var $author$project$CheckList$ResetCheckList = {$: 11};
var $elm$html$Html$button = _VirtualDom_node('button');
var $author$project$CheckList$getTotalCheckListItems = function (dict) {
...
var $author$project$CheckList$getTotalCheckedItems = function (dict) {
	return $elm$core$List$length(
		A2(
...
var $author$project$CheckList$viewCheckListItem = F4(
	function (key, item, isSubItem, isComplete) {
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('level mb-1'),
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('title mb-2 level-left level-item'),
							$elm$html$Html$Attributes$classList(
							_List_fromArray(
								[
									_Utils_Tuple2('is-5', isSubItem),
									_Utils_Tuple2('is-3', !isSubItem)
								]))
						]),
					_List_fromArray(
						[
...
var $author$project$CheckList$viewCheckListItemHelper = F4(
	function (key, description, isSubItem, model) {
		return A4(
			...
			description,
			isSubItem,
			A2($author$project$CheckList$getCompletedState, key, model.g));
	});
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('level-item level-right title is-6')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(
								$elm$core$String$fromInt(
									$author$project$CheckList$getTotalCheckedItems(model.g)) + (' of ' + $elm$core$String$fromInt(
									$author$project$CheckList$getTotalCheckListItems(model.g))))
							])),
						A2(
						$elm$html$Html$span,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('level-item level-right')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('button is-warning is-small'),
										$elm$html$Html$Events$onClick($author$project$CheckList$ResetCheckList)
									]),
								_List_fromArray(
									[
					...
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text(
								$elm$core$String$fromInt(
									$author$project$CheckList$getTotalCheckListItems(model.g) - $author$project$CheckList$getTotalCheckedItems(model.g)) + ' items left.')
							]))
					]))
			]));
};
var $author$project$CheckList$HideEditor = {$: 1};
...
var $author$project$CheckList$viewHeaderEdit = function (model) {
	return A2(
		$elm$html$Html$nav,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						_Utils_Tuple2('is-hidden', !model.B)
					]))
			]),
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Events$onClick($author$project$CheckList$HideEditor)
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Edit Heading')
							]))
					])),
				A2(
				$elm$html$Html$div,
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$placeholder('Flight Number'),
								$elm$html$Html$Events$onInput($author$project$CheckList$UpdateFlightNumber)
							]),
						_List_Nil),
						A2(
						$elm$html$Html$input,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('input'),
								$elm$html$Html$Attributes$type_('text'),
								$elm$html$Html$Attributes$placeholder('Departure Airport'),
								$elm$html$Html$Events$onInput($author$project$CheckList$UpdateDepartureAirport)
							]),
						_List_Nil),
						A2(
						$elm$html$Html$input,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('input'),
								$elm$html$Html$Attributes$type_('text'),
								$elm$html$Html$Attributes$placeholder('Arrival Airport'),
								$elm$html$Html$Events$onInput($author$project$CheckList$UpdateArrivalAirport)
							]),
						_List_Nil),
						A2(
						$elm$html$Html$input,
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('input'),
								$elm$html$Html$Attributes$type_('text'),
								$elm$html$Html$Attributes$placeholder('Gate'),
								$elm$html$Html$Events$onInput($author$project$CheckList$UpdateGate)
							]),
						_List_Nil)
					]))
			]));
};
var $author$project$CheckList$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
...
var $author$project$CheckList$main = $elm$browser$Browser$element(
	{aO: $author$project$CheckList$init, aZ: $author$project$CheckList$subscriptions, a0: $author$project$CheckList$updateWithStorage, a1: $author$project$CheckList$view});
